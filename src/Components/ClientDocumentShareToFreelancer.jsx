import "./ClientDocumentShareToFreelancer.css";

function ClientDocumentShareToFreelancer() {
  return (
    <div style={{ marginBottom: "200px" }} className="body">
      <header>
...
export default ClientDocumentShareToFreelancer;
